...
def run(processes):
    ...
    def findWaitingTime(processes, n):
        ...
        while (complete != n): 
            ...
            if (rt[short] == 0):  
                ...
                processes[short].waiting_time = (fint - processes[short].arrival_time - processes[short].burst_time) 
    ...
    def findTurnAroundTime(processes, n): 
        ...
        for i in range(n): 
		processes[i].turnaround_time = processes[i].arrival_time + processes[i].waiting_time
